...
//Education Section Component with lang Prop (which is used to know which langauge the app has to load the appropriate  translated JSON data)
const EduSection = ({ lang }) => {
  ...
  const content = require(`../../../locales/${lang}/dynamic-content/education_content.json`);
  ...
  return (
    <>
      <div className="resume-block-description__wrapper">
        <Fade triggerOnce>
          <Typography className="resume-block-description__title" variant="h6">
            {useNextTranslate('resume:ui_resume-block-title-2')}
          </Typography>
        </Fade>
      </div>
      <Grid
      ...
      >
        ...
        >
          <Grid container>
            {content.map((educationcard) => (
              <Grid
                key={educationcard.education_card_id}
                item
                xs={12}
                sm={12}
                md={6}
                    ...
                    >
                      <div className="resume-work-exp-card__text-wrapper">
                        <Typography className="resume-work-exp-card__date-title">
                          {educationcard.education_card_date}
                        </Typography>
                        <Typography className="resume-work-exp-card__job-title">
                          {educationcard.education_card_name}
                        </Typography>
                        <Typography className="resume-work-exp-card__firm-title">
                          {educationcard.education_card_edu_type}
                        </Typography>
                        <Typography className="resume-work-exp-card__firm-title">
                          {educationcard.education_card_place}
                        </Typography>
                      </div>
                    </AccordionSummary>
                    ...
                    <AccordionDetails>
                      ...
                      >
                        <Typography className="resume-work-exp-card__task-description">
                          {educationcard.education_card_description}
                        </Typography>
                      </div>
                    </AccordionDetails>
                  </Accordion>
