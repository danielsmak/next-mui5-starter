...
//Calendly Appointement Button for Mobile View Component
const CalendlyLinkMobileBtn = () => {
  ...
  return (
    <>
      <Button
        ...
        variant="contained"
      >
        {useNextTranslate('home:ui_cross_section_calendly_btn-mobile')}
      </Button>
    </>
  );
};

export default CalendlyLinkMobileBtn;
